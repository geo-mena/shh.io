...
If you would like to contribute to the translations or add support for a new language, please refer to the [Contributing to Translations](https://github.com/geo-mena/enclosed/blob/main/packages/app-client/src/locales/README.md) guide.
